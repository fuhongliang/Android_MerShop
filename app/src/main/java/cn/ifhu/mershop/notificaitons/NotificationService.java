...
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_ACTION;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_ANSWER;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_BIG_PICTURE_STYLE;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_BIG_TEXT_STYLE;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_CUSTOM_HEADS_UP_VIEW;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_CUSTOM_VIEW;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_CUSTOM_VIEW_OPTIONS_CANCEL;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_CUSTOM_VIEW_OPTIONS_LOVE;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_CUSTOM_VIEW_OPTIONS_LYRICS;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_CUSTOM_VIEW_OPTIONS_NEXT;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_CUSTOM_VIEW_OPTIONS_PLAY_OR_PAUSE;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_CUSTOM_VIEW_OPTIONS_PRE;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_DELETE;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_INBOX_STYLE;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_MEDIA_STYLE;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_MESSAGING_STYLE;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_NO;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_PROGRESS;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_REJECT;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_REMOTE_INPUT;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_REPLY;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_SIMPLE;
import static cn.ifhu.mershop.notificaitons.Notificaitons.ACTION_YES;
import static cn.ifhu.mershop.notificaitons.Notificaitons.EXTRA_OPTIONS;
import static cn.ifhu.mershop.notificaitons.Notificaitons.MEDIA_STYLE_ACTION_DELETE;
import static cn.ifhu.mershop.notificaitons.Notificaitons.MEDIA_STYLE_ACTION_NEXT;
import static cn.ifhu.mershop.notificaitons.Notificaitons.MEDIA_STYLE_ACTION_PAUSE;
import static cn.ifhu.mershop.notificaitons.Notificaitons.MEDIA_STYLE_ACTION_PLAY;
import static cn.ifhu.mershop.notificaitons.Notificaitons.NOTIFICATION_ACTION;
import static cn.ifhu.mershop.notificaitons.Notificaitons.NOTIFICATION_CUSTOM;
import static cn.ifhu.mershop.notificaitons.Notificaitons.NOTIFICATION_CUSTOM_HEADS_UP;
import static cn.ifhu.mershop.notificaitons.Notificaitons.NOTIFICATION_MEDIA_STYLE;
import static cn.ifhu.mershop.notificaitons.Notificaitons.NOTIFICATION_REMOTE_INPUT;
import static cn.ifhu.mershop.notificaitons.Notificaitons.REMOTE_INPUT_RESULT_KEY;
