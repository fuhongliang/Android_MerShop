...
import cn.ifhu.mershop.activity.LaunchActivity;
...
public class Notificaitons {
    ...
    public void sendOrderComingNotification(Context context, NotificationManager nm,String title,String text,String contentTitle) {
        //创建点击通知时发送的广播
        ...
        //发送通知
        nm.notify(NOTIFICATION_SAMPLE,nb.build());
        AudioUtil.getInstance(context).openRawMusicS(context,false,R.raw.ring);
    }
