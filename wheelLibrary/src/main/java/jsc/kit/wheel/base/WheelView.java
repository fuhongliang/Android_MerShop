...
public class WheelView extends View implements IWheelViewSetting {
    ...
    private static final int DEFAULT_VELOCITY_UNITS = 0;
     ...
     */
    private int itemVerticalSpace = 10;
    /**
    ...
    private int[] calculateResult = new int[2];
    ...
    public void initAttr(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        float defaultTextSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 40, getResources().getDisplayMetrics());
        ...
        itemVerticalSpace = a.getDimensionPixelSize(R.styleable.WheelView_wheelItemVerticalSpace, 40);
