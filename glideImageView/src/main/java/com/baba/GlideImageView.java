...
import com.baba.progress.OnProgressListener;
import com.baba.transformation.CircleTransformation;
...
public class GlideImageView extends ImageView {
    ...
    public void loadCircle(Uri uri, @DrawableRes int placeholder) {
        load(uri, placeholder, new CircleTransformation(), null);
    }
